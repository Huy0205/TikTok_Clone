...
export const FollowCheckIcon = ({ size = '1em' }) => (
    <svg
        fill="currentColor"
        color="inherit"
        fontSize="inherit"
...
export const ShareRegularIcon = ({ size = '1em' }) => (
    <svg
        fill="currentColor"
        color="inherit"
        fontSize="inherit"
...
export const PlayRegularIcon = ({ size = '18px' }) => (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="#fff" xmlns="http://www.w3.org/2000/svg">
        <path
            fillRule="evenodd"
            clipRule="evenodd"
...
export const SettingRegularIcon = ({ size = '1em' }) => (
    <svg
        fill="currentColor"
        color="inherit"
        fontSize="inherit"
